...
'User taps on Accounts'
Mobile.tap(findTestObject('Object Repository/M25SP5DGA-03/13_UserTapsOnAccounts'), 0)

'Verify Text for 6-digit PIN'
Mobile.verifyElementText(findTestObject('Object Repository/M25SP5DGA-03/04_VerifyHeaderText- 6-digit PIN'), '6-digit PIN')

'Verify text asking to Enter your 6-digit PIN'
...
'Take screenshot for the PIN screen'
...
'Verify Element when the yser navigates to the Accounts screen after entering PIN'
...
'Take screenshot for the Accounts list screen'
Mobile.takeScreenshot('C:\\Users\\AMBRAN~1\\AppData\\Local\\Temp\\screenshot4273555855694925823.png')
Mobile.takeScreenshot()
...
'Verify element when user navigates to the dashboard'
...
'User taps on Acounts'
Mobile.tap(findTestObject('Object Repository/M25SP5DGA-03/13_UserTapsOnAccounts'), 0)

'User navigates drectly to the accounts list screen'
Mobile.verifyElementText(findTestObject('Object Repository/M25SP5DGA-03/07_VerifyText - ACCOUNTS'), 'ACCOUNTS')
